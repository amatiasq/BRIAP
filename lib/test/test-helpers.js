function hideMochaSuccess() {
	...
	select('#mocha-div .suite').concat(select('#mocha-div .test')).forEach(function(el) {
		el.style.display = 'none';
	});

	select('#mocha-div .fail').forEach(function(current) {
		failed = true;
	...
	select('#mocha-div .suiteFail').forEach(function(el) {
...
function htmlcov() {
	...
	var mocha = document.querySelector('#mocha-div')
